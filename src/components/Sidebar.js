      ...
      <div className="sidebar">
        <nav className="sidebar-nav">
          <ul className="nav">
            ...
            <li className={this.activeRoute("/secure")}>
              <a className="nav-link nav-dropdown-toggle" href="#" onClick={this.handleClick.bind(this)}><i className="icon-lock"></i> Secure</a>
              <ul className="nav-dropdown-items">
                <li className="nav-item">
                  <Link to={'/secure/userlist'} className="nav-link" activeClassName="active"><i className="icon-lock"></i> User List</Link>
                </li>
                <li className="nav-item">
                  <Link to={'/secure/applist'} className="nav-link" activeClassName="active"><i className="icon-lock"></i> App List</Link>
                </li>
              </ul>
            </li>
